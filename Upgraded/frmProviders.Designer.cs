...
namespace SKS
{
	partial class frmProviders
	{
		...
		private void InitializeComponent()
		{
			...
			this.dcProviders.BOFAction = UpgradeHelpers.DB.Controls.BOFActionEnum.MoveFirst;
			...
			this.dcProviders.EOFAction = UpgradeHelpers.DB.Controls.EOFActionEnum.MoveLast;
