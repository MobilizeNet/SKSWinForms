...
namespace SKS
{
	partial class frmProducts
	{
		...
		private void InitializeComponent()
		{
			...
			this.dcProducts.BOFAction = UpgradeHelpers.DB.Controls.BOFActionEnum.MoveFirst;
			...
			this.dcProducts.EOFAction = UpgradeHelpers.DB.Controls.EOFActionEnum.MoveLast;
